...
var BBCodeParser = (function (parserTags, parserColors) {
    ...
    function replaceTagsAndContent(matchStr, tagName, tagParams, tagContents) {
        ...
        tagParams = tagParams || "";
        tagContents = tagContents || "";
        return parserTags[tagName].openTag(tagParams, tagContents) + (parserTags[tagName].content ? parserTags[tagName].content(tagParams, tagContents) : tagContents) + parserTags[tagName].closeTag(tagContents);
    }
